...
export const targetSentenceToRoute = new Map<string, [string, string, string[], Record<string, any>]>([
  ...
  ["get the assignment '' student submission", ["get", "/:userId/class/:classId/assignment/:assignmentName", ["assignmentName", "submission"], { assignmentName: "", submission: true, accountType: UserRole.Professor}]],
  ["get all the student submissions assignment ''", ["get", "/:userId/class/:classId/assignment/:assignmentName", ["assignmentName", "submission", "accountType"], { assignmentName: "", submission: true, accountType: UserRole.Professor }]],
  ...
  ["get the student submission '' assignment ''", ["get", "/:userId/class/:classId/assignment/:assignmentName", ["studentName", "assignmentName", "submission", "accountType"], { studentName: "", assignmentName: "", submission: true, accountType: UserRole.Professor }]],
